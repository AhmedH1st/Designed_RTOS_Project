...
{
	/*****Set to work on normal mode .. and maybe complete the driver when have time*****/
	...
	/*************** these config done to serve Servo Project (as no time to completer driver)*********************/

	/*************** work on fast PWM mode, bit TOP, NON_inverting  *************************/
...
void M_void_Timer1_FastPWM_OCR_Direct_input (Timer1_OCR_t OCR_ID ,u16 OCR_value)
{
	switch(OCR_ID)
	{
	case OCR_1A:
